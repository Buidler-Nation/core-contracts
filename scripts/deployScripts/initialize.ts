...
async function main() {
  ...
  // TODO: mint BDN and transfer it to NTT contract
  ...
  // // Deposit 5,000,000 MIM and mint 5,000,000 BDN
  // await treasury.deposit(
  //   "5000000000000000000000000", // reserve token amount to deposit
  //   mim.address,
  //   "5000000000000000000000000" // amount of bdn to mint
  // );
  ...
  console.log("BDN: " + bdnAdd);
  console.log("MIM Token: " + mim);
  ...
  console.log("sBDN: " + sBDNAdd);
  console.log("RewardDistributor: " + RewardDistributorAdd);
  console.log("MIM-BDN Bond: " + mimBond.address);
}
